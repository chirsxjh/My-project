...
def Train() :
	...
	print(session.run(accuracy, feed_dict = {x:mnist.test.images[0:2000], y:mnist.test.labels[0:2000], keep_prob:1}))
...
save_path = "/home/xiang/mygit/学习记录和随笔/network/cnn.ckpt"
